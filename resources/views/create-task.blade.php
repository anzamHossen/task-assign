                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="task_name" class="form-control" value="{{ old('task_name') }}" placeholder="Enter the task name">                         
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="task_priority" value="{{ old('task_priority') }}" class="form-select">
